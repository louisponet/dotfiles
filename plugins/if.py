...
class If(dotbot.Plugin):
    ...
    def _load_plugins(self):
        ...
        for path in plugin_paths:
            ...
            plugins.extend(dotbot.util.module.load(abspath))
        if not self._context.options().disable_built_in_plugins:
            plugins.extend([dotbot.plugins.Clean, dotbot.plugins.Create, dotbot.plugins.Link, dotbot.plugins.Shell])
        return plugins

    def _run_internal(self, data):
        dispatcher = dotbot.dispatcher.Dispatcher(
